...
const i18n = {
  id: {
    ...
    "exp2.d3":         "Pengolahan data penginderaan jauh menggunakan ArcGIS, QGIS, dan Google Earth Engine (GEE)",
  ...
  en: {
    ...
    "exp2.d3":         "Remote sensing data processing using ArcGIS, QGIS, and Google Earth Engine (GEE)",
